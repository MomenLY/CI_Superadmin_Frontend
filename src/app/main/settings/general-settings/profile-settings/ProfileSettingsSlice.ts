...
// export const useProfileManagementDispatch = () => useDispatch<AppDispatch>();
// export const useProfileManagementSelector: TypedUseSelectorHook<RootState> = useSelector;

export const userUpdateDispatch = () => useDispatch<AppDispatch>();
export const userUpdateSelector: TypedUseSelectorHook<RootState> = useSelector;
